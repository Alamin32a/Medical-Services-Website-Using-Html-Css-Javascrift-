...
/* Animated Headline | https://codyhouse.co/gem/css-animated-headlines */
jQuery(document).ready(function(s) {
    ...
    function u(i) {
        var e = C(i);
        if (i.parents(".dtr-animated-headline").hasClass("type")) {
            var a = i.parent(".dtr-words-wrapper");
        ...
        } else if (i.parents(".dtr-animated-headline").hasClass("letters")) {
            ...
            }(i.find("i").eq(0), i, p, r), m(e.find("i").eq(0), e, p, r)
        } else i.parents(".dtr-animated-headline").hasClass("clip") ? i.parents(".dtr-words-wrapper").animate({
            width: "2px"
        }, c, function() {
            w(i, e), f(e)
        }) : i.parents(".dtr-animated-headline").hasClass("loading-bar") ? (i.parents(".dtr-words-wrapper").removeClass("is-loading"), w(i, e), setTimeout(function() {
            u(e)
        }, n), setTimeout(function() {
            i.parents(".dtr-words-wrapper").addClass("is-loading")
    ...
    function f(s, i) {
        s.parents(".dtr-animated-headline").hasClass("type") ? (m(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".dtr-animated-headline").hasClass("clip") && s.parents(".dtr-words-wrapper").animate({
            width: s.width() + 10
        }, c, function() {
            setTimeout(function() {
                u(s)
    ...
    function m(s, i, e, a) {
        s.addClass("in").removeClass("out"), s.is(":last-child") ? (i.parents(".dtr-animated-headline").hasClass("type") && setTimeout(function() {
            i.parents(".dtr-words-wrapper").addClass("waiting")
    ...
    s(".dtr-animated-headline.letters").find("b").each(function() {
        var e = s(this),
            a = e.text().split(""),
    ...
    }), e = s(".dtr-animated-headline"), a = t, e.each(function() {
        var i = s(this);
        if (i.hasClass("loading-bar")) a = n, setTimeout(function() {
            i.find(".dtr-words-wrapper").addClass("is-loading")
        }, d);
        else if (i.hasClass("clip")) {
            var e = i.find(".dtr-words-wrapper"),
                t = e.width() + 10;
            e.css("width", t)
        } else if (!i.hasClass("type")) {
            var r = i.find(".dtr-words-wrapper b"),
                l = 0;
            r.each(function() {
                var i = s(this).width();
                i > l && (l = i)
            }), i.find(".dtr-words-wrapper").css("width", l)
        }
        setTimeout(function() {
...
! function(e) {
    ...
    e.fn.attr2 = function() {
        ...
        !1 !== a.iframe && (a.iframe || S) ? a.closeKeepAlive ? e.get(a.closeKeepAlive, function() {
            ...
            if (a.extraData) {
                var o = function(t) {
                    var r, n, i = e.param(t, a.traditional).split("&"),
                        o = i.length,
                        s = [];
        ...
        function k(t) {
            var o, s, c, l, f, p, d, h, v, g, x, b, y = u[0],
                T = e.Deferred();
        ...
        for (o = 0, f = h.length; o < f; o++)
            if ((u = (l = h[o]).name) && !l.disabled)
                if (r && p.clk && "image" == l.type) p.clk == l && (n.push({
                    name: u,
                    value: e(l).val(),
                    type: l.type
                }), n.push({
                ...
                else if ((c = e.fieldValue(l, !0)) && c.constructor == Array)
            for (a && a.push(l), s = 0, m = c.length; s < m; s++) n.push({
                name: u,
                value: c[s]
            });
    ...
    m.prototype.init = function() {
        ...
        e(f).each(function() {
            ...
            if (n.children = t.children("ul").attr("role", "menu"), t.data("menu", n), n.children.length > 0) {
                ...
                if (h.allowParentLinks && !h.nestedParentLinks && i) e(o).wrapAll('<span class="' + s + "_parent-link " + s + '_row"/>').parent();
                else e(o).wrapAll(l).parent().addClass(s + "_row");
            ...
            switch ((t || event).keyCode) {
                ...
                case u:
                    t.preventDefault();
                    var a, l = (a = e(t.target).parent().parent().children().children('[role="menuitem"]:visible')).index(t.target);
                    a.eq(l - 1).focus();
                    break;
                case c:
